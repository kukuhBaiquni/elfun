  ...
  return (
    <div className='relative z-10'>
      ...
      <ul className={`px-2.5 mt-1 ${collapse ? 'h-0' : 'h-[540px]'} transition-all duration-300`}>
        {towns.map((item) => (
          <li className={`relative ${collapse ? 'opacity-0' : 'opacity-100'} hover:text-white cursor-pointer text-gray-600 dark:text-gray-400 dark:hover:text-white group hover:bg-sky-500 hover:translate-x-2 transition-transform-opacity duration-300`} key={item.name}>
