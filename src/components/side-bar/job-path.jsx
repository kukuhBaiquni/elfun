...
function JobPath({ data = [] }) {
  return (
    <ul className='absolute group-hover:opacity-100 opacity-0 -bottom-full p-2 rounded -right-3/4 bg-white drop-shadow-2xl border border-gray-200 border-solid group-hover:translate-x-10 transition-all duration-300'>
      {data.map((firstJob) => (
