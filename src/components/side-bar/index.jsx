...
function Sidebar() {
  ...
  return (
    <nav className='font-titillium mr-0 sm:mr-3'>
      <ul className='py-2 px-2 bg-gray-200 dark:bg-gray-700 min-h-[750px] max-h-full w-60 hidden sm:block transition-all duration-300'>
